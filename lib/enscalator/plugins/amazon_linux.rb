    ...
    module AmazonLinux
      class << self
        ...
        def get_ami(region:, release: '2015.09.1', storage: :ebs, arch: :x86_64, ebs_type: :gp2, filters: {})
          ...
          fail StandardError, "Could not find any Linux Amazon Ami that fits the criteria: #{region}, #{release}, #{storage}, #{arch}, #{ebs_type}, #{filters}" unless resp.images
      ...
      def amazon_linux_init(region: self.region, release: '2015.09.1', storage: :ebs, arch: :x86_64, ebs_type: :gp2, filters: {})
        parameter_ami 'AmazonLinux', AmazonLinux.get_ami(region: region, release: '2015.09.1', storage: :ebs, arch: :x86_64, ebs_type: :gp2, filters: {})
      end
