...
rich_template do
  ...
  mapping 'AWSRegionNetConfig',
          ...
          :'eu-northeast-1' => { :VPC => '10.48.0.0/16', :Public1 => '10.48.0.0/24', :Public2 => '10.48.4.0/24' },
          :'eu-southeast-2' => { :VPC => '10.56.0.0/16', :Public1 => '10.56.0.0/24', :Public2 => '10.56.4.0/24' },
  ...
  resource 'PublicSubnet1', :DependsOn => [ 'VPC' ], :Type => 'AWS::EC2::Subnet', :Properties => {
      ...
      :CidrBlock => find_in_map('AWSRegionNetConfig', aws_region, 'Public1'),
      :Tags => [
          {
              :Key => 'Application',
              :Value => aws_stack_name,
  ...
  resource 'PublicSubnet2', :DependsOn => [ 'VPC' ], :Type => 'AWS::EC2::Subnet', :Properties => {
      ...
      :CidrBlock => find_in_map('AWSRegionNetConfig', aws_region, 'Public2'),
      :Tags => [
          {
              :Key => 'Application',
              :Value => aws_stack_name,
  ...
  resource 'NATDevice1', :DependsOn => [ 'PublicSubnet1', 'NATSecurityGroup' ], :Type => 'AWS::EC2::Instance', :Properties => {
      ...
      :ImageId => find_in_map('AWSNATAMI', aws_region, 'AMI'),
      :NetworkInterfaces => [
          {
